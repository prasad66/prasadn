  ...
  const renderDrawer: () => ReactNode = () => (
    ...
    >
      ...
      <List>
        ...
        <SideBarButton text="About ME" name="skills">
          <BuildIcon />
        </SideBarButton>
  ...
  return (
    <>
      <Head>
        ...
        {/* <!-- Primary Meta Tags --> */}
        <meta name="title" content="Prasad" />
        <meta
          name="description"
          content="Hi, I am Prasad, an adventurer in web development."
          key="description"
        />
        ...
        />
        <meta property="og:title" content="Prasad" />
        <meta
        ...
        <meta
          ...
          content={`https://${process.env.NEXT_PUBLIC_VERCEL_URL}`}
        />
        <meta property="twitter:title" content="Prasad" />
        <meta
